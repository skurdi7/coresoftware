...
int CMCompareRvsIntFluct(int nMaxEvents = -1) {
  ...
  for (int ifile=0;ifile < nEvents;ifile++){
    ...
    for(int ihist=0;ihist < 2;ihist++){//should be ihist < 10 to run over all
      ...
      hCompareRTruevIntFluctSmallRPosRegion[0] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion0", "True vs Int Fluct Region 0, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-2e7,1e7,nbinsint,-10,10);
      hCompareRTruevIntFluctSmallRPosRegion[1] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion1", "True vs Int Fluct Region 1, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-2e7,1e7,nbinsint,-30,10);
      ...
      hCompareRTruevIntFluctSmallRPosRegion[6] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion6", "True vs Int Fluct Region 6, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-13e7,-3e7,nbinsint,-20,20);
      hCompareRTruevIntFluctSmallRPosRegion[7] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion7", "True vs Int Fluct Region 7, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-13e7,-3e7,nbinsint,-20,20);
      hCompareRTruevIntFluctSmallRPosRegion[8] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion8", "True vs Int Fluct Region 8, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-12e7,1e7,nbinsint,-5,5);

      //true vs int fluct outside
      TH2F *hCompareRTruevIntFluctLargeRPosRegion[9];
      hCompareRTruevIntFluctLargeRPosRegion[0] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion0", "True vs Int Fluct Region 0, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-2e7,1e7,nbinsint,-10,10);
      hCompareRTruevIntFluctLargeRPosRegion[1] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion1", "True vs Int Fluct Region 1, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-2e7,1e7,nbinsint,-30,10);
      hCompareRTruevIntFluctLargeRPosRegion[2] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion2", "True vs Int Fluct Region 2, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-2e7,1e7,nbinsint,-15,5);
      ...
      hCompareRTruevIntFluctLargeRPosRegion[5] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion5", "True vs Int Fluct Region 5, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-1e8,1e7,nbinsint,-10,10);
      hCompareRTruevIntFluctLargeRPosRegion[6] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion6", "True vs Int Fluct Region 6, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-13e7,-3e7,nbinsint,-20,20);
      hCompareRTruevIntFluctLargeRPosRegion[7] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion7", "True vs Int Fluct Region 7, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-13e7,-3e7,nbinsint,-20,20);
      hCompareRTruevIntFluctLargeRPosRegion[8] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion8", "True vs Int Fluct Region 8, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-12e7,1e7,nbinsint,-5,5);
      
      //true vs net int fluct
      TH2F *hCompareRTruevIntFluctDiffRPosRegion[9];
      hCompareRTruevIntFluctDiffRPosRegion[0] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion0", "True vs Net Int Fluct Region 0, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRTruevIntFluctDiffRPosRegion[1] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion1", "True vs Net Int Fluct Region 1, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRTruevIntFluctDiffRPosRegion[2] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion2", "True vs Net Int Fluct Region 2, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-15,15);
      ...
      hCompareRTruevIntFluctDiffRPosRegion[5] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion5", "True vs Net Int Fluct Region 5, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-1e8,1e8,nbinsint,-5,5);
      hCompareRTruevIntFluctDiffRPosRegion[6] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion6", "True vs Net Int Fluct Region 6, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-1e7,12e7,nbinsint,-20,20);
      hCompareRTruevIntFluctDiffRPosRegion[7] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion7", "True vs Net Int Fluct Region 7, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-1e7,12e7,nbinsint,-20,20);
      hCompareRTruevIntFluctDiffRPosRegion[8] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion8", "True vs Net Int Fluct Region 8, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-1e7,12e7,nbinsint,-5,5);
      
      //model-true vs int fluct inside
       TH2F *hCompareRDiffvIntFluctSmallRPosRegion[9];
      hCompareRDiffvIntFluctSmallRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion0", "Model-True vs Int Fluct Region 0, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-15e7,-3e7,nbinsint,-10,5);
      hCompareRDiffvIntFluctSmallRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion1", "Model-True vs Int Fluct Region 1, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-15e7,-3e7,nbinsint,-10,5);
      hCompareRDiffvIntFluctSmallRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion2", "Model-True vs Int Fluct Region 2, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-12e7,1e7,nbinsint,-5,5);
      ...
      hCompareRDiffvIntFluctSmallRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion6", "Model-True vs Int Fluct Region 6, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-4e7,1e7,nbinsint,-15,10);
      hCompareRDiffvIntFluctSmallRPosRegion[7] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion7", "Model-True vs Int Fluct Region 7, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-4e7,1e7,nbinsint,-10,15);
      hCompareRDiffvIntFluctSmallRPosRegion[8] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion8", "Model-True vs Int Fluct Region 8, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-4e7,1e7,nbinsint,-5,5);
      
      //model-true vs int fluct outside
      TH2F *hCompareRDiffvIntFluctLargeRPosRegion[9];
      hCompareRDiffvIntFluctLargeRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion0", "Model-True vs Int Fluct Region 0, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-2e7,1e7,nbinsint,-10,5);
      hCompareRDiffvIntFluctLargeRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion1", "Model-True vs Int Fluct Region 1, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-2e7,1e7,nbinsint,-12,4);
      hCompareRDiffvIntFluctLargeRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion2", "Model-True vs Int Fluct Region 2, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-2e7,1e7,nbinsint,-4,4);
      ...
      hCompareRDiffvIntFluctLargeRPosRegion[5] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion5", "Model-True vs Int Fluct Region 5, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-1e8,1e7,nbinsint,-5,5);
      hCompareRDiffvIntFluctLargeRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion6", "Model-True vs Int Fluct Region 6, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-15e7,-3e7,nbinsint,-12,10);
      hCompareRDiffvIntFluctLargeRPosRegion[7] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion7", "Model-True vs Int Fluct Region 7, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-15e7,-3e7,nbinsint,-10,15);
      ...
      hCompareRDiffvIntFluctDiffRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion0", "Model-True vs Net Int Fluct Region 0, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,-1e7,nbinsint,-10,5);
      hCompareRDiffvIntFluctDiffRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion1", "Model-True vs Net Int Fluct Region 1, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,-1e7,nbinsint,-10,5);
      hCompareRDiffvIntFluctDiffRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion2", "Model-True vs Net Int Fluct Region 2, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-5,5);
      hCompareRDiffvIntFluctDiffRPosRegion[3] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion3", "Model-True vs Net Int Fluct Region 3, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e8,nbinsint,-8,8);
      ...
      hCompareRDiffvIntFluctDiffRPosRegion[5] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion5", "Model-True vs Net Int Fluct Region 5, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-12e7,1e8,nbinsint,-5,5);
      hCompareRDiffvIntFluctDiffRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion6", "Model-True vs Net Int Fluct Region 6, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,1e7,3e8,nbinsint,-10,10);
      hCompareRDiffvIntFluctDiffRPosRegion[7] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion7", "Model-True vs Net Int Fluct Region 7, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,1e7,3e8,nbinsint,-10,15);
      hCompareRDiffvIntFluctDiffRPosRegion[8] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion8", "Model-True vs Net Int Fluct Region 8, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-1e7,12e7,nbinsint,-6,6);
