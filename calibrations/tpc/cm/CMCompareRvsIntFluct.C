...
int CMCompareRvsIntFluct(int nMaxEvents = -1) {
  ...
  for (int ifile=1;ifile < nEvents;ifile++){
    ...
    for(int ihist=0;ihist < 2;ihist++){//should be ihist < 10 to run over all
      ...
      hCompareRTruevIntFluctSmallRPosRegion[2] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion2", "True vs Int Fluct Region 2, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-12e7,1e7,nbinsint,-2,2);
      ...
      hCompareRTruevIntFluctSmallRPosRegion[5] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion5", "True vs Int Fluct Region 5, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-1e8,1e7,nbinsint,-5,5);
      hCompareRTruevIntFluctSmallRPosRegion[6] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion6", "True vs Int Fluct Region 6, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-3e7,5e6,nbinsint,-25,30);
      hCompareRTruevIntFluctSmallRPosRegion[7] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion7", "True vs Int Fluct Region 7, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-3e7,5e6,nbinsint,-30,25);
      ...
      hCompareRTruevIntFluctLargeRPosRegion[2] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion2", "True vs Int Fluct Region 2, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-1e7,2e6,nbinsint,-2,2);
      ...
      hCompareRTruevIntFluctLargeRPosRegion[8] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion8", "True vs Int Fluct Region 8, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-11e7,1e7,nbinsint,-5,5);
      ...
      hCompareRDiffvIntFluctSmallRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion0", "Model-True vs Int Fluct Region 0, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-13e7,-3e7,nbinsint,-10,5);
      hCompareRDiffvIntFluctSmallRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion1", "Model-True vs Int Fluct Region 1, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-13e7,-3e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctSmallRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion2", "Model-True vs Int Fluct Region 2, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-12e7,1e7,nbinsint,-2,2);
      ...
      hCompareRDiffvIntFluctLargeRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion2", "Model-True vs Int Fluct Region 2, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-1e7,2e6,nbinsint,-2,2);
      ...
      hCompareRDiffvIntFluctDiffRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion0", "Model-True vs Net Int Fluct Region 0, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-14e7,-3e7,nbinsint,-10,5);
      hCompareRDiffvIntFluctDiffRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion1", "Model-True vs Net Int Fluct Region 1, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-14e7,-3e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctDiffRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion2", "Model-True vs Net Int Fluct Region 2, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-2,2);
      ...
      hCompareRDiffvIntFluctDiffRPosRegion[4] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion4", "Model-True vs Net Int Fluct Region 4, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e8,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosRegion[5] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion5", "Model-True vs Net Int Fluct Region 5, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-1e8,8e7,nbinsint,-5,5);
      hCompareRDiffvIntFluctDiffRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion6", "Model-True vs Net Int Fluct Region 6, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,1e7,15e7,nbinsint,-15,10);
      hCompareRDiffvIntFluctDiffRPosRegion[7] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion7", "Model-True vs Net Int Fluct Region 7, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,1e7,15e7,nbinsint,-10,20);
