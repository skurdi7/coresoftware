...
int CMCompareRvsIntFluct(int nMaxEvents = -1) {
  ...
  for (int ifile=0;ifile < nEvents;ifile++){
    ...
    for(int ihist=0;ihist < 2;ihist++){//should be ihist < 10 to run over all
      ...
      hCompareRTruevIntFluctSmallRPosRegion[0] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion0", "True vs Int Fluct Region 0, Pos Side, R Inside; int fluct charge inside (ions); true shift (#mum)",nbinsint,-3e8,-18e7,nbinsint,-10,10);
      hCompareRTruevIntFluctSmallRPosRegion[1] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion1", "True vs Int Fluct Region 1, Pos Side, R Inside; int fluct charge inside (ions); true shift (#mum)",nbinsint,-3e8,-15e7,nbinsint,-35,15);
      hCompareRTruevIntFluctSmallRPosRegion[2] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion2", "True vs Int Fluct Region 2, Pos Side, R Inside; int fluct charge inside (ions); true shift (#mum)",nbinsint,-2e8,1e7,nbinsint,-1,0.2);
      hCompareRTruevIntFluctSmallRPosRegion[3] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion3", "True vs Int Fluct Region 3, Pos Side, R Inside; int fluct charge inside (ions); true shift (#mum)",nbinsint,-3e8,-4e7,nbinsint,-25,20);
      hCompareRTruevIntFluctSmallRPosRegion[4] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion4", "True vs Int Fluct Region 4, Pos Side, R Inside; int fluct charge inside (ions); true shift (#mum)",nbinsint,-3e8,-2e7,nbinsint,-25,20);
      hCompareRTruevIntFluctSmallRPosRegion[5] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion5", "True vs Int Fluct Region 5, Pos Side, R Inside; int fluct charge inside (ions); true shift (#mum)",nbinsint,-3e8,1e7,nbinsint,-4,4);
      hCompareRTruevIntFluctSmallRPosRegion[6] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion6", "True vs Int Fluct Region 6, Pos Side, R Inside; int fluct charge inside (ions); true shift (#mum)",nbinsint,-8e7,5e6,nbinsint,-25,30);
      hCompareRTruevIntFluctSmallRPosRegion[7] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion7", "True vs Int Fluct Region 7, Pos Side, R Inside; int fluct charge inside (ions); true shift (#mum)",nbinsint,-5e7,5e6,nbinsint,-30,25);
      hCompareRTruevIntFluctSmallRPosRegion[8] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion8", "True vs Int Fluct Region 8, Pos Side, R Inside; int fluct charge inside (ions); true shift (#mum)",nbinsint,-5e7,5e6,nbinsint,-5,5);

      //pg 2: true vs int fluct outside
      TH2F *hCompareRTruevIntFluctLargeRPosRegion[9];
      hCompareRTruevIntFluctLargeRPosRegion[0] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion0", "True vs Int Fluct Region 0, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-15e6,2e6,nbinsint,-6,10);
      hCompareRTruevIntFluctLargeRPosRegion[1] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion1", "True vs Int Fluct Region 1, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-15e6,2e6,nbinsint,-35,15);
      hCompareRTruevIntFluctLargeRPosRegion[2] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion2", "True vs Int Fluct Region 2, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-2e7,1e6,nbinsint,-1.5,1.5);
      hCompareRTruevIntFluctLargeRPosRegion[3] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion3", "True vs Int Fluct Region 3, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-3e8,0.0,nbinsint,-15,15);
      hCompareRTruevIntFluctLargeRPosRegion[4] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion4", "True vs Int Fluct Region 4, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-3e8,0.0,nbinsint,-10,15);
      hCompareRTruevIntFluctLargeRPosRegion[5] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion5", "True vs Int Fluct Region 5, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-2e8,1e7,nbinsint,-3,3);
      hCompareRTruevIntFluctLargeRPosRegion[6] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion6", "True vs Int Fluct Region 6, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-3e8,-16e7,nbinsint,-30,20);
      hCompareRTruevIntFluctLargeRPosRegion[7] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion7", "True vs Int Fluct Region 7, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-3e8,-13e7,nbinsint,-30,30);
      hCompareRTruevIntFluctLargeRPosRegion[8] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion8", "True vs Int Fluct Region 8, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-3,3);
      
      //pg 3: true vs net int fluct
      TH2F *hCompareRTruevIntFluctDiffRPosRegion[9];
      hCompareRTruevIntFluctDiffRPosRegion[0] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion0", "True vs Net Int Fluct Region 0, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-3e8,-17e7,nbinsint,-8,10);
      hCompareRTruevIntFluctDiffRPosRegion[1] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion1", "True vs Net Int Fluct Region 1, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-3e8,-14e7,nbinsint,-10,15);
      hCompareRTruevIntFluctDiffRPosRegion[2] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion2", "True vs Net Int Fluct Region 2, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-3e8,1e7,nbinsint,-1,1);
      hCompareRTruevIntFluctDiffRPosRegion[3] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion3", "True vs Net Int Fluct Region 3, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-3e8,3e8,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosRegion[4] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion4", "True vs Net Int Fluct Region 4, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-3e8,3e8,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosRegion[5] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion5", "True vs Net Int Fluct Region 5, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-3e8,3e8,nbinsint,-5,5);
      hCompareRTruevIntFluctDiffRPosRegion[6] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion6", "True vs Net Int Fluct Region 6, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,1e8,3.5e8,nbinsint,-25,-5);
      hCompareRTruevIntFluctDiffRPosRegion[7] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion7", "True vs Net Int Fluct Region 7, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,8e7,4e8,nbinsint,-30,15);
      hCompareRTruevIntFluctDiffRPosRegion[8] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion8", "True vs Net Int Fluct Region 8, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-1e7,3e8,nbinsint,-4,4);
      
      //pg 4: model-true vs int fluct inside
       TH2F *hCompareRDiffvIntFluctSmallRPosRegion[9];
      hCompareRDiffvIntFluctSmallRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion0", "Model-True vs Int Fluct Region 0, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-3e8,-19e7,nbinsint,-4,2);
      hCompareRDiffvIntFluctSmallRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion1", "Model-True vs Int Fluct Region 1, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-3e8,-15e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctSmallRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion2", "Model-True vs Int Fluct Region 2, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-3e8,0.0,nbinsint,-0.5,1.5);
      hCompareRDiffvIntFluctSmallRPosRegion[3] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion3", "Model-True vs Int Fluct Region 3, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-4e8,-4e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctSmallRPosRegion[4] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion4", "Model-True vs Int Fluct Region 4, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-3e8,-4e7,nbinsint,-10,15);
      hCompareRDiffvIntFluctSmallRPosRegion[5] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion5", "Model-True vs Int Fluct Region 5, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-3e8,1e6,nbinsint,-5,4);
      hCompareRDiffvIntFluctSmallRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion6", "Model-True vs Int Fluct Region 6, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-9e7,3e6,nbinsint,-18,10);
      hCompareRDiffvIntFluctSmallRPosRegion[7] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion7", "Model-True vs Int Fluct Region 7, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-9e7,5e6,nbinsint,-10,25);
      hCompareRDiffvIntFluctSmallRPosRegion[8] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion8", "Model-True vs Int Fluct Region 8, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-9e7,5e6,nbinsint,-5,5);
      
      //pg 5: model-true vs int fluct outside
      TH2F *hCompareRDiffvIntFluctLargeRPosRegion[9];
      hCompareRDiffvIntFluctLargeRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion0", "Model-True vs Int Fluct Region 0, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-2e7,1e6,nbinsint,-10,4);
      hCompareRDiffvIntFluctLargeRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion1", "Model-True vs Int Fluct Region 1, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-3e7,3e6,nbinsint,-12,8);
      hCompareRDiffvIntFluctLargeRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion2", "Model-True vs Int Fluct Region 2, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-2e7,1e6,nbinsint,-2,2);
      hCompareRDiffvIntFluctLargeRPosRegion[3] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion3", "Model-True vs Int Fluct Region 3, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-2e8,-1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctLargeRPosRegion[4] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion4", "Model-True vs Int Fluct Region 4, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-3e8,1e7,nbinsint,-10,12);
      hCompareRDiffvIntFluctLargeRPosRegion[5] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion5", "Model-True vs Int Fluct Region 5, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-1e8,1e7,nbinsint,-2,3);
      hCompareRDiffvIntFluctLargeRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion6", "Model-True vs Int Fluct Region 6, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-3e8,-16e7,nbinsint,-15,10);
      hCompareRDiffvIntFluctLargeRPosRegion[7] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion7", "Model-True vs Int Fluct Region 7, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-2e8,-13e7,nbinsint,-10,25);
      hCompareRDiffvIntFluctLargeRPosRegion[8] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion8", "Model-True vs Int Fluct Region 8, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-2e8,1e7,nbinsint,-6,6);
      
      //pg 6: model-true vs net int fluct
      TH2F *hCompareRDiffvIntFluctDiffRPosRegion[9];
      hCompareRDiffvIntFluctDiffRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion0", "Model-True vs Net Int Fluct Region 0, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-3e8,-17e7,nbinsint,-5,5);
      hCompareRDiffvIntFluctDiffRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion1", "Model-True vs Net Int Fluct Region 1, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-3e8,-14e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctDiffRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion2", "Model-True vs Net Int Fluct Region 2, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-3e8,1e7,nbinsint,-2,2);
      hCompareRDiffvIntFluctDiffRPosRegion[3] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion3", "Model-True vs Net Int Fluct Region 3, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-3e8,3e8,nbinsint,-8,8);
      hCompareRDiffvIntFluctDiffRPosRegion[4] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion4", "Model-True vs Net Int Fluct Region 4, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-3e8,3e8,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosRegion[5] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion5", "Model-True vs Net Int Fluct Region 5, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,2e8,nbinsint,-5,5);
      hCompareRDiffvIntFluctDiffRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion6", "Model-True vs Net Int Fluct Region 6, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,1e8,4e8,nbinsint,-15,10);
      hCompareRDiffvIntFluctDiffRPosRegion[7] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion7", "Model-True vs Net Int Fluct Region 7, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,8e7,4e8,nbinsint,-10,20);
      hCompareRDiffvIntFluctDiffRPosRegion[8] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion8", "Model-True vs Net Int Fluct Region 8, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-1e7,2e8,nbinsint,-4,4);
      ...
      //pg 8: dividing true vs net int fluct, region4 into 9 sub-regions in r
      TH2F *hCompareRTruevIntFluctDiffRPosReg4SubregR[9];
      hCompareRTruevIntFluctDiffRPosReg4SubregR[0] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR0", "True vs Net Int Fluct Region 4, R Sub-Region 0, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-15e7,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[1] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR1", "True vs Net Int Fluct Region 4, R Sub-Region 1, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[2] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR2", "True vs Net Int Fluct Region 4, R Sub-Region 2, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[3] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR3", "True vs Net Int Fluct Region 4, R Sub-Region 3, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[4] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR4", "True vs Net Int Fluct Region 4, R Sub-Region 4, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[5] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR5", "True vs Net Int Fluct Region 4, R Sub-Region 5, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[6] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR6", "True vs Net Int Fluct Region 4, R Sub-Region 6, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[7] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR7", "True vs Net Int Fluct Region 4, R Sub-Region 7, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[8] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR8", "True vs Net Int Fluct Region 4, R Sub-Region 8, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);

      //pg 9: dividing true vs net int fluct, region4 into 9 sub-regions in phi
      TH2F *hCompareRTruevIntFluctDiffRPosReg4SubregPhi[9];
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[0] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi0", "True vs Net Int Fluct Region 4, Phi Sub-Region 0, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[1] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi1", "True vs Net Int Fluct Region 4, Phi Sub-Region 1, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[2] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi2", "True vs Net Int Fluct Region 4, Phi Sub-Region 2, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[3] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi3", "True vs Net Int Fluct Region 4, Phi Sub-Region 3, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[4] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi4", "True vs Net Int Fluct Region 4, Phi Sub-Region 4, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[5] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi5", "True vs Net Int Fluct Region 4, Phi Sub-Region 5, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[6] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi6", "True vs Net Int Fluct Region 4, Phi Sub-Region 6, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[7] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi7", "True vs Net Int Fluct Region 4, Phi Sub-Region 7, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[8] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi8", "True vs Net Int Fluct Region 4, Phi Sub-Region 8, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);

       //pg 10: dividing true vs net int fluct, region4 into 9 sub-regions in z
      TH2F *hCompareRTruevIntFluctDiffRPosReg4SubregZ[9];
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[0] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ0", "True vs Net Int Fluct Region 4, Z Sub-Region 0, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[1] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ1", "True vs Net Int Fluct Region 4, Z Sub-Region 1, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[2] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ2", "True vs Net Int Fluct Region 4, Z Sub-Region 2, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[3] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ3", "True vs Net Int Fluct Region 4, Z Sub-Region 3, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[4] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ4", "True vs Net Int Fluct Region 4, Z Sub-Region 4, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[5] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ5", "True vs Net Int Fluct Region 4, Z Sub-Region 5, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[6] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ6", "True vs Net Int Fluct Region 4, Z Sub-Region 6, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[7] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ7", "True vs Net Int Fluct Region 4, Z Sub-Region 7, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[8] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ8", "True vs Net Int Fluct Region 4, Z Sub-Region 8, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-2e8,0.0,nbinsint,-25,20);

      //pg 11: dividing model-true vs net int fluct, region4 into 9 sub-regions in r 
      TH2F *hCompareRDiffvIntFluctDiffRPosReg4SubregR[9];
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[0] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR0", "Model-True vs Net Int Fluct Region 4, R Sub-Region 0, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[1] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR1", "Model-True vs Net Int Fluct Region 4, R Sub-Region 1, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[2] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR2", "Model-True vs Net Int Fluct Region 4, R Sub-Region 2, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[3] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR3", "Model-True vs Net Int Fluct Region 4, R Sub-Region 3, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[4] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR4", "Model-True vs Net Int Fluct Region 4, R Sub-Region 4, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[5] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR5", "Model-True vs Net Int Fluct Region 4, R Sub-Region 5, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[6] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR6", "Model-True vs Net Int Fluct Region 4, R Sub-Region 6, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[7] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR7", "Model-True vs Net Int Fluct Region 4, R Sub-Region 7, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[8] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR8", "Model-True vs Net Int Fluct Region 4, R Sub-Region 8, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);

      //pg 12: dividing model-true vs net int fluct, region4 into 9 sub-regions in phi
      TH2F *hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[9];
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[0] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi0", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 0, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[1] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi1", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 1, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[2] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi2", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 2, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[3] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi3", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 3, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[4] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi4", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 4, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[5] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi5", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 5, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[6] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi6", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 6, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[7] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi7", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 7, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[8] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi8", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 8, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);

       //pg 13: dividing model-true vs net int fluct, region4 into 9 sub-regions in z
      TH2F *hCompareRDiffvIntFluctDiffRPosReg4SubregZ[9];
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[0] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ0", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 0, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[1] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ1", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 1, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[2] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ2", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 2, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[3] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ3", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 3, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[4] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ4", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 4, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[5] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ5", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 5, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[6] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ6", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 6, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[7] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ7", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 7, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[8] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ8", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 8, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-2e8,0.0,nbinsint,-10,12);
	...
	for(int j = 1; j < nr - 1; j++){
	  ...
	  for(int k = 1; k < nz - 1; k++){
		...
		if(r < (30.0 + srwidth)){
		  ...
		  hCompareRDiffvIntFluctDiffRPosReg4SubregR[0]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		  ...
		  hCompareRDiffvIntFluctDiffRPosReg4SubregR[1]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		  ...
		  hCompareRDiffvIntFluctDiffRPosReg4SubregR[2]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		  ...
		  hCompareRDiffvIntFluctDiffRPosReg4SubregR[3]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		  ...
		  hCompareRDiffvIntFluctDiffRPosReg4SubregR[4]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		  ...
		  hCompareRDiffvIntFluctDiffRPosReg4SubregR[5]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		  ...
		  hCompareRDiffvIntFluctDiffRPosReg4SubregR[6]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		  ...
		  hCompareRDiffvIntFluctDiffRPosReg4SubregR[7]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		}else if((r >= (30.0 + 8.0*srwidth))){
		  hCompareRTruevIntFluctDiffRPosReg4SubregR[8]->Fill(intfluctchargeSmallRPos,shifttrueCylPos[0]);
		  hCompareRDiffvIntFluctDiffRPosReg4SubregR[8]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		}
		...
		hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[0]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		...
		hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[1]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		...
		hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[2]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		...
		hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[3]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		...
		hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[4]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		...
		hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[5]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		...
		hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[6]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		...
		hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[7]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		...
		hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[8]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		}

		//z
		double szwidth = (90.0 - 15.0)/9.0; //width of phi subreg
		if (zPos< (15.0 + szwidth)){
		hCompareRTruevIntFluctDiffRPosReg4SubregZ[0]->Fill(intfluctchargeSmallRPos,shifttrueCylPos[0]);
		hCompareRDiffvIntFluctDiffRPosReg4SubregZ[0]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		}else if((zPos>= (15.0 + szwidth)) && (zPos< (15.0 + 2.0*szwidth))){
		hCompareRTruevIntFluctDiffRPosReg4SubregZ[1]->Fill(intfluctchargeSmallRPos,shifttrueCylPos[0]);
		hCompareRDiffvIntFluctDiffRPosReg4SubregZ[1]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		}else if((zPos>= (15.0 + 2.0*szwidth)) && (zPos< (15.0 + 3.0*szwidth))){
		hCompareRTruevIntFluctDiffRPosReg4SubregZ[2]->Fill(intfluctchargeSmallRPos,shifttrueCylPos[0]);
		hCompareRDiffvIntFluctDiffRPosReg4SubregZ[2]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		}else if((zPos>= (15.0 + 3.0*szwidth)) && (zPos< (15.0 + 4.0*szwidth))){
		hCompareRTruevIntFluctDiffRPosReg4SubregZ[3]->Fill(intfluctchargeSmallRPos,shifttrueCylPos[0]);
		hCompareRDiffvIntFluctDiffRPosReg4SubregZ[3]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		}else if((zPos>= (15.0 + 4.0*szwidth)) && (zPos< (15.0 + 5.0*szwidth))){
		hCompareRTruevIntFluctDiffRPosReg4SubregZ[4]->Fill(intfluctchargeSmallRPos,shifttrueCylPos[0]);
		hCompareRDiffvIntFluctDiffRPosReg4SubregZ[4]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		}else if((zPos>= (15.0 + 5.0*szwidth)) && (zPos< (15.0 + 6.0*szwidth))){
		hCompareRTruevIntFluctDiffRPosReg4SubregZ[5]->Fill(intfluctchargeSmallRPos,shifttrueCylPos[0]);
		hCompareRDiffvIntFluctDiffRPosReg4SubregZ[5]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		}else if((zPos>= (15.0 + 6.0*szwidth)) && (zPos< (15.0 + 7.0*szwidth))){
		hCompareRTruevIntFluctDiffRPosReg4SubregZ[6]->Fill(intfluctchargeSmallRPos,shifttrueCylPos[0]);
		hCompareRDiffvIntFluctDiffRPosReg4SubregZ[6]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		}else if((zPos>= (15.0 + 7.0*szwidth)) && (zPos< (15.0 + 8.0*szwidth))){
		hCompareRTruevIntFluctDiffRPosReg4SubregZ[7]->Fill(intfluctchargeSmallRPos,shifttrueCylPos[0]);
		hCompareRDiffvIntFluctDiffRPosReg4SubregZ[7]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		}else if((zPos>= (15.0 + 8.0*szwidth))){
		hCompareRTruevIntFluctDiffRPosReg4SubregZ[8]->Fill(intfluctchargeSmallRPos,shifttrueCylPos[0]);
		hCompareRDiffvIntFluctDiffRPosReg4SubregZ[8]->Fill(intfluctchargeSmallRPos,differenceCylPhiRPos[0]);
		}
		...
		hCompareRDiffvIntFluctDiffRPosRegion[8]->Fill(intfluctchargeDiffRPos,differenceCylPhiRPos[0]);
			...
			//localized plot
		if((1.0 < shifttrueCylPos[0]) && (shifttrueCylPos[0] < 2.5) && (-2e6 < intfluctchargeSmallRPos) && (intfluctchargeSmallRPos < 2e6)){
