...
int CMCompareRvsIntFluct(int nMaxEvents = -1) {
  ...
  for (int ifile=0;ifile < nEvents;ifile++){
    ...
    for(int ihist=0;ihist < 2;ihist++){//should be ihist < 10 to run over all
      ...
      hCompareRTruevIntFluctDiffRPosReg4SubregR[3] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR3", "True vs Net Int Fluct Region 4, R Sub-Region 3, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-3e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[4] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR4", "True vs Net Int Fluct Region 4, R Sub-Region 4, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,-5e7,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[5] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR5", "True vs Net Int Fluct Region 4, R Sub-Region 5, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,-5e7,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[6] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR6", "True vs Net Int Fluct Region 4, R Sub-Region 6, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,-1e8,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[7] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR7", "True vs Net Int Fluct Region 4, R Sub-Region 7, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,-1e8,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregR[8] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregR8", "True vs Net Int Fluct Region 4, R Sub-Region 8, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,-1e8,nbinsint,-25,20);

      //pg 9: dividing true vs net int fluct, region4 into 9 sub-regions in phi
      TH2F *hCompareRTruevIntFluctDiffRPosReg4SubregPhi[9];
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[0] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi0", "True vs Net Int Fluct Region 4, Phi Sub-Region 0, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[1] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi1", "True vs Net Int Fluct Region 4, Phi Sub-Region 1, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[2] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi2", "True vs Net Int Fluct Region 4, Phi Sub-Region 2, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[3] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi3", "True vs Net Int Fluct Region 4, Phi Sub-Region 3, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[4] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi4", "True vs Net Int Fluct Region 4, Phi Sub-Region 4, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[5] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi5", "True vs Net Int Fluct Region 4, Phi Sub-Region 5, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[6] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi6", "True vs Net Int Fluct Region 4, Phi Sub-Region 6, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[7] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi7", "True vs Net Int Fluct Region 4, Phi Sub-Region 7, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregPhi[8] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregPhi8", "True vs Net Int Fluct Region 4, Phi Sub-Region 8, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0,nbinsint,-25,20);

       //pg 10: dividing true vs net int fluct, region4 into 9 sub-regions in z
      TH2F *hCompareRTruevIntFluctDiffRPosReg4SubregZ[9];
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[0] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ0", "True vs Net Int Fluct Region 4, Z Sub-Region 0, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[1] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ1", "True vs Net Int Fluct Region 4, Z Sub-Region 1, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[2] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ2", "True vs Net Int Fluct Region 4, Z Sub-Region 2, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[3] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ3", "True vs Net Int Fluct Region 4, Z Sub-Region 3, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[4] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ4", "True vs Net Int Fluct Region 4, Z Sub-Region 4, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[5] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ5", "True vs Net Int Fluct Region 4, Z Sub-Region 5, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[6] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ6", "True vs Net Int Fluct Region 4, Z Sub-Region 6, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[7] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ7", "True vs Net Int Fluct Region 4, Z Sub-Region 7, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0.0,nbinsint,-25,20);
      hCompareRTruevIntFluctDiffRPosReg4SubregZ[8] = new TH2F("hCompareRTruevIntFluctDiffRPosReg4SubregZ8", "True vs Net Int Fluct Region 4, Z Sub-Region 8, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-4e8,0.0,nbinsint,-25,20);
      ...
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[3] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR3", "Model-True vs Net Int Fluct Region 4, R Sub-Region 3, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-3e8,-5e7,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[4] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR4", "Model-True vs Net Int Fluct Region 4, R Sub-Region 4, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,-5e7,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[5] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR5", "Model-True vs Net Int Fluct Region 4, R Sub-Region 5, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,-1e8,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[6] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR6", "Model-True vs Net Int Fluct Region 4, R Sub-Region 6, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,-1e8,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[7] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR7", "Model-True vs Net Int Fluct Region 4, R Sub-Region 7, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,-1e8,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregR[8] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregR8", "Model-True vs Net Int Fluct Region 4, R Sub-Region 8, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,-1e8,nbinsint,-10,12);
      ...
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[0] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi0", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 0, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[1] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi1", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 1, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[2] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi2", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 2, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[3] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi3", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 3, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[4] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi4", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 4, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[5] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi5", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 5, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[6] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi6", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 6, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[7] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi7", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 7, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregPhi[8] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregPhi8", "Model-True vs Net Int Fluct Region 4, Phi Sub-Region 8, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      ...
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[0] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ0", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 0, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[1] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ1", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 1, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[2] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ2", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 2, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[3] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ3", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 3, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[4] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ4", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 4, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[5] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ5", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 5, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[6] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ6", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 6, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[7] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ7", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 7, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
      hCompareRDiffvIntFluctDiffRPosReg4SubregZ[8] = new TH2F("hCompareRDiffvIntFluctDiffRPosReg4SubregZ8", "Model-True vs Net Int Fluct Region 4, Z Sub-Region 8, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-4e8,0.0,nbinsint,-10,12);
