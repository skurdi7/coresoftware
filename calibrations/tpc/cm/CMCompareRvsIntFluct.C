...
int CMCompareRvsIntFluct(int nMaxEvents = -1) {
  ...
  for (int ifile=0;ifile < nEvents;ifile++){
    ...
    for(int ihist=0;ihist < 2;ihist++){//should be ihist < 10 to run over all
      ...
      hCompareRTruevIntFluctSmallRPosRegion[1] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion1", "True vs Int Fluct Region 1, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctSmallRPosRegion[2] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion2", "True vs Int Fluct Region 2, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctSmallRPosRegion[3] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion3", "True vs Int Fluct Region 3, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctSmallRPosRegion[4] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion4", "True vs Int Fluct Region 4, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctSmallRPosRegion[5] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion5", "True vs Int Fluct Region 5, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctSmallRPosRegion[6] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion6", "True vs Int Fluct Region 6, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctSmallRPosRegion[7] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion7", "True vs Int Fluct Region 7, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctSmallRPosRegion[8] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion8", "True vs Int Fluct Region 8, Pos Side, R Inside; int fluct charge inside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);

      //true vs int fluct outside
      TH2F *hCompareRTruevIntFluctLargeRPosRegion[9];
      hCompareRTruevIntFluctLargeRPosRegion[0] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion0", "True vs Int Fluct Region 0, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctLargeRPosRegion[1] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion1", "True vs Int Fluct Region 1, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctLargeRPosRegion[2] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion2", "True vs Int Fluct Region 2, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctLargeRPosRegion[3] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion3", "True vs Int Fluct Region 3, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctLargeRPosRegion[4] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion4", "True vs Int Fluct Region 4, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctLargeRPosRegion[5] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion5", "True vs Int Fluct Region 5, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctLargeRPosRegion[6] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion6", "True vs Int Fluct Region 6, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctLargeRPosRegion[7] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion7", "True vs Int Fluct Region 7, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      hCompareRTruevIntFluctLargeRPosRegion[8] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion8", "True vs Int Fluct Region 8, Pos Side, R Outside; int fluct charge outside (#mum); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-20,20);
      
      //true vs net int fluct
      TH2F *hCompareRTruevIntFluctDiffRPosRegion[9];
      hCompareRTruevIntFluctDiffRPosRegion[0] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion0", "True vs Net Int Fluct Region 0, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-15e7,1e8,nbinsint,-20,20);
      hCompareRTruevIntFluctDiffRPosRegion[1] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion1", "True vs Net Int Fluct Region 1, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-15e7,1e8,nbinsint,-20,20);
      hCompareRTruevIntFluctDiffRPosRegion[2] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion2", "True vs Net Int Fluct Region 2, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-15e7,1e8,nbinsint,-20,20);
      hCompareRTruevIntFluctDiffRPosRegion[3] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion3", "True vs Net Int Fluct Region 3, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-15e7,1e8,nbinsint,-20,20);
      hCompareRTruevIntFluctDiffRPosRegion[4] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion4", "True vs Net Int Fluct Region 4, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-15e7,1e8,nbinsint,-20,20);
      hCompareRTruevIntFluctDiffRPosRegion[5] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion5", "True vs Net Int Fluct Region 5, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-15e7,1e8,nbinsint,-20,20);
      hCompareRTruevIntFluctDiffRPosRegion[6] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion6", "True vs Net Int Fluct Region 6, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-15e7,1e8,nbinsint,-20,20);
      hCompareRTruevIntFluctDiffRPosRegion[7] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion7", "True vs Net Int Fluct Region 7, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-15e7,1e8,nbinsint,-20,20);
      hCompareRTruevIntFluctDiffRPosRegion[8] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion8", "True vs Net Int Fluct Region 8, Pos Side; net int fluct charge (#mum); true shift (#mum)",nbinsint,-15e7,1e8,nbinsint,-20,20);
      
      //model-true vs int fluct inside
       TH2F *hCompareRDiffvIntFluctSmallRPosRegion[9];
      hCompareRDiffvIntFluctSmallRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion0", "Model-True vs Int Fluct Region 0, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctSmallRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion1", "Model-True vs Int Fluct Region 1, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctSmallRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion2", "Model-True vs Int Fluct Region 2, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctSmallRPosRegion[3] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion3", "Model-True vs Int Fluct Region 3, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      ...
      hCompareRDiffvIntFluctSmallRPosRegion[5] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion5", "Model-True vs Int Fluct Region 5, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctSmallRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion6", "Model-True vs Int Fluct Region 6, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctSmallRPosRegion[7] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion7", "Model-True vs Int Fluct Region 7, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctSmallRPosRegion[8] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion8", "Model-True vs Int Fluct Region 8, Pos Side, R Inside; int fluct charge inside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      
      //model-true vs int fluct outside
      TH2F *hCompareRDiffvIntFluctLargeRPosRegion[9];
      hCompareRDiffvIntFluctLargeRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion0", "Model-True vs Int Fluct Region 0, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctLargeRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion1", "Model-True vs Int Fluct Region 1, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctLargeRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion2", "Model-True vs Int Fluct Region 2, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctLargeRPosRegion[3] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion3", "Model-True vs Int Fluct Region 3, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctLargeRPosRegion[4] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion4", "Model-True vs Int Fluct Region 4, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctLargeRPosRegion[5] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion5", "Model-True vs Int Fluct Region 5, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctLargeRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion6", "Model-True vs Int Fluct Region 6, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctLargeRPosRegion[7] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion7", "Model-True vs Int Fluct Region 7, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      hCompareRDiffvIntFluctLargeRPosRegion[8] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion8", "Model-True vs Int Fluct Region 8, Pos Side, R Outside; int fluct charge outside (#mum); shift difference (#mum)",nbinsint,-15e7,1e7,nbinsint,-10,10);
      
      //model-true vs net int fluct
      TH2F *hCompareRDiffvIntFluctDiffRPosRegion[9];
      hCompareRDiffvIntFluctDiffRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion0", "Model-True vs Net Int Fluct Region 0, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e8,nbinsint,-10,10);
      hCompareRDiffvIntFluctDiffRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion1", "Model-True vs Net Int Fluct Region 1, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e8,nbinsint,-10,10);
      hCompareRDiffvIntFluctDiffRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion2", "Model-True vs Net Int Fluct Region 2, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e8,nbinsint,-10,10);
      hCompareRDiffvIntFluctDiffRPosRegion[3] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion3", "Model-True vs Net Int Fluct Region 3, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e8,nbinsint,-10,10);
      hCompareRDiffvIntFluctDiffRPosRegion[4] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion4", "Model-True vs Net Int Fluct Region 4, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e8,nbinsint,-10,10);
      hCompareRDiffvIntFluctDiffRPosRegion[5] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion5", "Model-True vs Net Int Fluct Region 5, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e8,nbinsint,-10,10);
      hCompareRDiffvIntFluctDiffRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion6", "Model-True vs Net Int Fluct Region 6, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e8,nbinsint,-10,10);
      hCompareRDiffvIntFluctDiffRPosRegion[7] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion7", "Model-True vs Net Int Fluct Region 7, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e8,nbinsint,-10,10);
      hCompareRDiffvIntFluctDiffRPosRegion[8] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion8", "Model-True vs Net Int Fluct Region 8, Pos Side; net int fluct charge (#mum); shift difference (#mum)",nbinsint,-15e7,1e8,nbinsint,-10,10);
