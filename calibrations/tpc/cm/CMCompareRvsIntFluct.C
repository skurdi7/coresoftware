...
int CMCompareRvsIntFluct(int nMaxEvents = -1) {
  ...
  for (int ifile=0;ifile < nEvents;ifile++){
    ...
    for(int ihist=0;ihist < 2;ihist++){//should be ihist < 10 to run over all
      ...
      hCompareRTruevIntFluctSmallRPosRegion[0] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion0", "True vs Int Fluct Region 0, Pos Side, R Inside; int fluct charge inside (ions); true shift (#mum)",nbinsint,-24e7,-14e7,nbinsint,-10,10);
      hCompareRTruevIntFluctSmallRPosRegion[1] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion1", "True vs Int Fluct Region 1, Pos Side, R Inside; int fluct charge inside (ions); true shift (#mum)",nbinsint,-23e7,-12e7,nbinsint,-35,15);
      hCompareRTruevIntFluctSmallRPosRegion[2] = new TH2F("hCompareRTruevIntFluctSmallRPosRegion2", "True vs Int Fluct Region 2, Pos Side, R Inside; int fluct charge inside (ions); true shift (#mum)",nbinsint,-15e7,1e7,nbinsint,-1,1);
      ...
      hCompareRTruevIntFluctLargeRPosRegion[0] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion0", "True vs Int Fluct Region 0, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-15e6,3e6,nbinsint,-6,10);
      hCompareRTruevIntFluctLargeRPosRegion[1] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion1", "True vs Int Fluct Region 1, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-15e6,3e6,nbinsint,-35,15);
      ...
      hCompareRTruevIntFluctLargeRPosRegion[6] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion6", "True vs Int Fluct Region 6, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-23e7,-13e7,nbinsint,-30,30);
      hCompareRTruevIntFluctLargeRPosRegion[7] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion7", "True vs Int Fluct Region 7, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-23e7,-13e7,nbinsint,-30,30);
      hCompareRTruevIntFluctLargeRPosRegion[8] = new TH2F("hCompareRTruevIntFluctLargeRPosRegion8", "True vs Int Fluct Region 8, Pos Side, R Outside; int fluct charge outside (ions); true shift (#mum)",nbinsint,-15e7,0.0,nbinsint,-3,3);
      
      //pg 3: true vs net int fluct
      TH2F *hCompareRTruevIntFluctDiffRPosRegion[9];
      hCompareRTruevIntFluctDiffRPosRegion[0] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion0", "True vs Net Int Fluct Region 0, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-24e7,-12e7,nbinsint,-8,10);
      hCompareRTruevIntFluctDiffRPosRegion[1] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion1", "True vs Net Int Fluct Region 1, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-24e7,-12e7,nbinsint,-10,15);
      hCompareRTruevIntFluctDiffRPosRegion[2] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion2", "True vs Net Int Fluct Region 2, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,-18e7,1e7,nbinsint,-1,1);
      ...
      hCompareRTruevIntFluctDiffRPosRegion[6] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion6", "True vs Net Int Fluct Region 6, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,1e8,3e8,nbinsint,-25,-10);
      hCompareRTruevIntFluctDiffRPosRegion[7] = new TH2F("hCompareRTruevIntFluctDiffRPosRegion7", "True vs Net Int Fluct Region 7, Pos Side; net int fluct charge (ions); true shift (#mum)",nbinsint,8e7,3e8,nbinsint,-30,10);
      ...
      hCompareRDiffvIntFluctSmallRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion0", "Model-True vs Int Fluct Region 0, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-23e7,-13e7,nbinsint,-10,5);
      hCompareRDiffvIntFluctSmallRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion1", "Model-True vs Int Fluct Region 1, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-23e7,-13e7,nbinsint,-10,10);
      ...
      hCompareRDiffvIntFluctSmallRPosRegion[3] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion3", "Model-True vs Int Fluct Region 3, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-3e8,-4e7,nbinsint,-10,10);
      ...
      hCompareRDiffvIntFluctSmallRPosRegion[5] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion5", "Model-True vs Int Fluct Region 5, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-3e8,1e6,nbinsint,-10,4);
      hCompareRDiffvIntFluctSmallRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion6", "Model-True vs Int Fluct Region 6, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-1e8,2e6,nbinsint,-18,10);
      hCompareRDiffvIntFluctSmallRPosRegion[7] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion7", "Model-True vs Int Fluct Region 7, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-1e8,5e6,nbinsint,-10,25);
      hCompareRDiffvIntFluctSmallRPosRegion[8] = new TH2F("hCompareRDiffvIntFluctSmallRPosRegion8", "Model-True vs Int Fluct Region 8, Pos Side, R Inside; int fluct charge inside (ions); shift difference (#mum)",nbinsint,-1e8,5e6,nbinsint,-5,5);
      ...
      hCompareRDiffvIntFluctLargeRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion1", "Model-True vs Int Fluct Region 1, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-5e7,1e6,nbinsint,-12,8);
      hCompareRDiffvIntFluctLargeRPosRegion[2] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion2", "Model-True vs Int Fluct Region 2, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-3e7,1e6,nbinsint,-2,2);
      ...
      hCompareRDiffvIntFluctLargeRPosRegion[5] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion5", "Model-True vs Int Fluct Region 5, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-1e8,1e7,nbinsint,-5,5);
      hCompareRDiffvIntFluctLargeRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctLargeRPosRegion6", "Model-True vs Int Fluct Region 6, Pos Side, R Outside; int fluct charge outside (ions); shift difference (#mum)",nbinsint,-2e8,-14e7,nbinsint,-15,10);
      ...
      hCompareRDiffvIntFluctDiffRPosRegion[0] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion0", "Model-True vs Net Int Fluct Region 0, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-24e7,-14e7,nbinsint,-10,5);
      hCompareRDiffvIntFluctDiffRPosRegion[1] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion1", "Model-True vs Net Int Fluct Region 1, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,-24e7,-13e7,nbinsint,-10,10);
      ...
      hCompareRDiffvIntFluctDiffRPosRegion[6] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion6", "Model-True vs Net Int Fluct Region 6, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,1e8,3e8,nbinsint,-15,10);
      hCompareRDiffvIntFluctDiffRPosRegion[7] = new TH2F("hCompareRDiffvIntFluctDiffRPosRegion7", "Model-True vs Net Int Fluct Region 7, Pos Side; net int fluct charge (ions); shift difference (#mum)",nbinsint,8e7,3e8,nbinsint,-10,20);
